...
<section className="portfolio">
  <div className="container">
    ...
    <div className="portfolio-header">
      ...
      <h2 className="title">Projects That Drive Results</h2>
      <p className="subtitle">
        Explore some of our recent work in website development, SEO, branding,
        and digital marketing. Every project is designed to help businesses grow online.
      </p>
    </div>
    ...
    <div className="projects-grid">
      ...
      {/* Card 1: Website */}
      <article className="card" data-category="website">
        <div className="card-preview preview-website has-img">
          <span className="tag">Website</span>
          <img className="project-img" src="/img/projects/project-4.jpg" alt="iamnitinsingh.in portfolio website project" width="900" height="900" loading="lazy" decoding="async" />
        </div>
        <div className="card-body">
          ...
          <h3 className="card-title">iamnitinsingh.in</h3>
      ...
      <article className="card" data-category="website">
        <div className="card-preview preview-shopify has-img">
          <span className="tag">Shopify Store</span>
          <img className="project-img" src="/img/projects/project-1.jpg" alt="ActiveChamp Shopify store project" width="900" height="600" loading="lazy" decoding="async" />
        </div>
        <div className="card-body">
          <div className="card-meta">
            ...
            <span className="meta-label meta-label-green">Shopify Development</span>
          </div>
          <h3 className="card-title">ActiveChamp</h3>
      ...
      {/* Card 3: SEO */}
      <article className="card" data-category="seo">
        <div className="card-preview preview-seo has-img">
          <span className="tag">SEO</span>
          <img className="project-img" src="/img/projects/project-3.jpg" alt="Business Growth SEO campaign project" width="900" height="600" loading="lazy" decoding="async" />
        </div>
        <div className="card-body">
          <div className="card-meta">
          ...
          <h3 className="card-title">Business Growth SEO</h3>
      ...
      {/* Card 4: Google Ads */}
      <article className="card" data-category="ads">
        ...
        <div className="card-body">
          ...
          <h3 className="card-title">Lead Generation Ads</h3>
      ...
      {/* Card 5: Branding */}
      <article className="card" data-category="branding">
        ...
        <div className="card-body">
          ...
          <h3 className="card-title">Forest &amp; Co. Skincare</h3>
      ...
      {/* Card 6: Social Media */}
      <article className="card" data-category="social">
        ...
        <div className="card-body">
          ...
          <h3 className="card-title">Engaging Social Campaigns</h3>
