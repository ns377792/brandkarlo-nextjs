                        ...
                        <div className="accordion" id="faqAccordion">
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="faqCollapse2" className="accordion-collapse collapse" aria-labelledby="faqHeading2" data-bs-parent="#faqAccordion">
                                    <div className="accordion-body">
                                        Most clients start seeing meaningful improvements in 3 to 6 months, depending on competition and starting point. See our <a href="/project">recent project case studies</a> for examples of the results we've delivered.
                                    </div>
                                </div>
                            </div>
