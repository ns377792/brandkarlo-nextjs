      ...
      <div className="container py-5 px-lg-5">
        <div className="row g-5">
          ...
          <div className="col-md-6 col-lg-3">
            ...
            <p><i className="fa fa-envelope me-3"></i><a className="contact-link" href="mailto:info@brandkarlo.in">info@brandkarlo.in</a></p>
            <p><i className="fa fa-envelope me-3"></i><a className="contact-link" href="mailto:contact@brandkarlo.in">contact@brandkarlo.in</a></p>
